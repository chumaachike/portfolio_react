  ...
  return (
    <header className="flex">
      ...
      <nav className="menu-button">
        <button type="button" className="menu-anchor flex" href="#">
          <img
            src={imgMenu}
            width="20"
            height="20"
      ...
      <nav className="menu-bar">
        ...
        <a className="menu-opt-cont flex" href="https://www.youtube.com/channel/UCKmOGDm2gQ-XydtP0Xrt5zQ" target="_blank" rel="noreferrer">
          <button type="button" className="menu-opt" id="blog-button">Youtube</button>
        </a>
      </nav>
    </header>
  );
